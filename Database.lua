...
-- Módulo 2: Toda la información que la IA necesita
-- ============================================================
...
Database.Comandos = {
    ...
    ["piramide"] = {
        tipo = "construccion",
        descripcion = "Construye una pirámide escalonada",
    ...
    ["parte"] = {
        tipo = "objeto",
        descripcion = "Crea una parte/bloque básico",
        parametros = {"tamaño", "color", "material"},
        ejemplos = {"parte azul", "parte 5x5x5 roja"},
        categoria = "objetos"
    },
    ...
    ["dia"] = {
        tipo = "mundo",
        descripcion = "Cambia la hora del día",
        parametros = {"hora"},
    ...
    ["explosion"] = {
        tipo = "efecto",
        descripcion = "Crea una explosión",
        parametros = {"potencia"},
...
-- ============================================================
-- CONSTRUCCIONES (Código generado)
-- ============================================================
...
Database.Assets = {
    ...
    -- Modelos populares (ejemplos)
    modelos = {
        arbol = 0, -- Agregar IDs reales
        carro = 0,
        casa_moderna = 0
    },
...
-- ============================================================
-- COLORES (Mapeo de nombres a BrickColor)
-- ============================================================
...
-- ============================================================
-- EXPLICACIONES (Para cuando el usuario pregunta)
-- ============================================================

Database.Explicaciones = {
    ["que es roblox"] = {
        titulo = "¿Qué es Roblox?",
        contenido = "Roblox es una plataforma de creación de juegos donde puedes crear y jugar experiencias creadas por otros usuarios.",
        categoria = "general"
    },
    
    ["que es lua"] = {
        titulo = "¿Qué es Lua?",
        contenido = "Lua es el lenguaje de programación usado en Roblox. Es simple, potente y perfecto para principiantes.",
        categoria = "programacion"
    },
    
    ["como funciono"] = {
        titulo = "¿Cómo funciona esta IA?",
        contenido = "Uso procesamiento de lenguaje natural para entender tus comandos, luego genero código Lua que ejecuto en el workspace.",
        categoria = "ia"
    },
    
    ["que es instance"] = {
        titulo = "¿Qué es Instance?",
        contenido = "Instance.new() crea objetos en Roblox. Por ejemplo: Instance.new('Part') crea una parte.",
        categoria = "programacion"
    },
    
    ["que es vector3"] = {
        titulo = "¿Qué es Vector3?",
...
Database.Plugins = {
    deshacer = {
        nombre = "Sistema de Deshacer",
        descripcion = "Permite deshacer la última construcción",
        activo = true,
        version = "1.0"
    },
    ...
    preview = {
        nombre = "Vista Previa",
        descripcion = "Muestra preview transparente antes de construir",
        activo = false, -- Se activará después
        version = "1.0"
    },
    
    exportar = {
        nombre = "Exportador",
        descripcion = "Exporta construcciones a JSON",
        activo = false,
        version = "1.0"
    }
}
...
-- ============================================================
-- SINONIMOS (Para mejor comprensión)
-- ============================================================

Database.Sinonimos = {
    ["crear"] = {"hacer", "construir", "generar", "edificar"},
    ["borrar"] = {"eliminar", "destruir", "quitar", "remover"},
    ["cambiar"] = {"modificar", "editar", "ajustar", "alterar"},
    ["ayuda"] = {"help", "comandos", "info", "?"},
    ["parte"] = {"bloque", "cubo", "ladrillo"},
}
...
1. Escribe comandos en lenguaje natural:
   • "casa roja"
   • "torre 15 azul"
   • "pirámide amarilla"

2. Combina parámetros:
   • "casa azul con techo naranja"
   • "torre 20 de metal verde"

3. Usa comandos de sistema:
   • "ayuda" - ver todos los comandos
   • "limpiar" - borrar todo

4. Aprende nuevos comandos:
   • "enseñar" - modo aprendizaje
]],
    
    avanzado = [[
🎓 TUTORIAL AVANZADO

1. Modificadores múltiples:
   • "velocidad 100 y salto 200"

2. Construcciones complejas:
   • "casa roja al lado de torre azul"

3. Efectos:
   • "torre con fuego en la punta"

4. Persistencia:
   • Tus construcciones se guardan
   • "listar" para ver guardados
]]
}
...
Database.Config = {
    version = "1.0.0",
    autor = "Tu Nombre",
    github = "https://github.com/tu-usuario/roblox-ai",
    actualizacion = "2025-02-12",
